...
if ( ! class_exists( 'Responsive_Page_Tester' ) ) {
	...
	class Responsive_Page_Tester {
		...
		/**
		 * Display a notice when the responsive page tester is deactivated.
		 */
		function admin_notice() {
			echo '<div class="updated"><p><strong>Responsive page testing</strong> was <a href="https://make.wordpress.org/core/2016/01/28/previewing-site-responsiveness-in-the-customizer/" target="_blank">added to WordPress core in version 4.5</a>; The <strong>Responsige Page Tester</strong> plugin has been <strong>deactivated</strong>.</p></div>';
		}
